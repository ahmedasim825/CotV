          ...
          SectionHeader(
            ...
            subtitle: needsKey
                ? 'Add a Groq key for instant answers, a Gemini key for '
                    'medical questions and research, or both. Milo routes '
                    'each request to whichever fits.'
                : 'Say what you want. Short commands go to Groq, medical '
                    'and research questions go to Gemini, and anything '
